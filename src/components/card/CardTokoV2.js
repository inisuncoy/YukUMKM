...
const CardTokoV2 = ({ logo, name, href, className }) => {
  return (
    <Link
      href={href ? href : '#'}
      className={`bg-[#faeced] rounded-lg hover:border hover:border-sky-500 ease-linear ${className}`}
    >
      <div className="aspect-square">
        <Image
          ...
          className="w-full h-full object-cover obejct-center rounded-lg pt-2 px-2"
        />
      </div>
